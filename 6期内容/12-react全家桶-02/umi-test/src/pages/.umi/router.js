...
let routes = [
  ...
  },
  {
    ...
    "routes": [
      ...
      {
        "component": () => React.createElement(require('E:/kaikeba-quanzhan/12-react全家桶-02/umi-test/node_modules/umi-build-dev/lib/plugins/404/NotFound.js').default, { pagesPath: 'src/pages', hasRoutesInConfig: true })
      }
    ]
  },
  {
